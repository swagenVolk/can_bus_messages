...
if (goals != null)  {
  ...
  goals.value += "\n";
  goals.value += "\nFamiliarize readers with the Cyclic Redundancy Check (CRC), which is a code generated by the sender from its frame data. ";
  goals.value += "\n  The receiver will calculate the CRC from the frame data it receives, and compare to that of the sender. ";
  goals.value += "\n  If the sender's and receiver's CRCs do not match, that means the sent frame was corrupted. ";
  goals.value += "\n";
